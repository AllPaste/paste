...
func (pq *PasteQuery) Where(ps ...predicate.Paste) *PasteQuery {
	pq.predicates = append(pq.predicates, ps...)
	return pq
}

// Limit adds a limit step to the query.
func (pq *PasteQuery) Limit(limit int) *PasteQuery {
	pq.limit = &limit
	return pq
}

// Offset adds an offset step to the query.
func (pq *PasteQuery) Offset(offset int) *PasteQuery {
	pq.offset = &offset
	return pq
}
...
func (pq *PasteQuery) Unique(unique bool) *PasteQuery {
	pq.unique = &unique
	return pq
}

// Order adds an order step to the query.
func (pq *PasteQuery) Order(o ...OrderFunc) *PasteQuery {
...
func (pq *PasteQuery) First(ctx context.Context) (*Paste, error) {
...
func (pq *PasteQuery) FirstX(ctx context.Context) *Paste {
...
func (pq *PasteQuery) Only(ctx context.Context) (*Paste, error) {
...
func (pq *PasteQuery) OnlyX(ctx context.Context) *Paste {
...
func (pq *PasteQuery) All(ctx context.Context) ([]*Paste, error) {
...
func (pq *PasteQuery) AllX(ctx context.Context) []*Paste {
...
func (pq *PasteQuery) Count(ctx context.Context) (int, error) {
	if err := pq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (pq *PasteQuery) CountX(ctx context.Context) int {
...
func (pq *PasteQuery) Exist(ctx context.Context) (bool, error) {
	if err := pq.prepareQuery(ctx); err != nil {
		return false, err
	}
...
func (pq *PasteQuery) ExistX(ctx context.Context) bool {
...
func (pq *PasteQuery) Clone() *PasteQuery {
	if pq == nil {
		return nil
	}
	return &PasteQuery{
		...
		predicates: append([]predicate.Paste{}, pq.predicates...),
...
//		Scan(ctx, &v)
//
func (pq *PasteQuery) GroupBy(field string, fields ...string) *PasteGroupBy {
	grbuild := &PasteGroupBy{config: pq.config}
...
func (pq *PasteQuery) Select(fields ...string) *PasteSelect {
	...
	selbuild := &PasteSelect{PasteQuery: pq}
	selbuild.label = paste.Label
...
func (pq *PasteQuery) Aggregate(fns ...AggregateFunc) *PasteSelect {
	return pq.Select().Aggregate(fns...)
}

func (pq *PasteQuery) prepareQuery(ctx context.Context) error {
...
func (pq *PasteQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Paste, error) {
	var (
		nodes = []*Paste{}
		_spec = pq.querySpec()
	)
...
func (pq *PasteQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := pq.querySpec()
...
func (pq *PasteQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (pq *PasteQuery) querySpec() *sqlgraph.QuerySpec {
...
func (pq *PasteQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
func (pgb *PasteGroupBy) Aggregate(fns ...AggregateFunc) *PasteGroupBy {
	pgb.fns = append(pgb.fns, fns...)
	return pgb
}

// Scan applies the group-by query and scans the result into the given value.
func (pgb *PasteGroupBy) Scan(ctx context.Context, v any) error {
...
func (pgb *PasteGroupBy) sqlScan(ctx context.Context, v any) error {
...
func (pgb *PasteGroupBy) sqlQuery() *sql.Selector {
...
func (ps *PasteSelect) Aggregate(fns ...AggregateFunc) *PasteSelect {
	ps.fns = append(ps.fns, fns...)
	return ps
}

// Scan applies the selector query and scans the result into the given value.
func (ps *PasteSelect) Scan(ctx context.Context, v any) error {
	if err := ps.prepareQuery(ctx); err != nil {
		return err
	}
	ps.sql = ps.PasteQuery.sqlQuery(ctx)
	return ps.sqlScan(ctx, v)
}

func (ps *PasteSelect) sqlScan(ctx context.Context, v any) error {
